...
const DesignAndDevelopement = () => {
  return (
    ...
    https://epicglobal.co.in/  */}
        ...
        <meta
          name="title"
          content="Website Design And Development|Website Design Company Noida|Epic Global"
        ></meta>
        <meta
          name="description"
          content="Epic Global, is a leading software development company specializing in providing web Design & Development and mobile software application development services to clients globally. visit now"
        ></meta>
      </Head>
