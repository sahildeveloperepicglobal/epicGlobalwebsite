...
export default function Home({ BlogData }: Home) {
  ...
  return (
    ...
    https://epicglobal.co.in/  */}
        ...
        <meta
          name="title"
          content="Outsourcing Services|Software Development|IT services|(BPO) Service
"
        ></meta>
        <meta
          name="description"
          content=" Epic Global offers a wide range of project management, project support, Design & Development, Online Marketing, and Bpo services are all services provided by Epic Global. visit now"
        ></meta>
      </Head>
