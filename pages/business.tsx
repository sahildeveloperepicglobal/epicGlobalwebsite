...
const BusinessProcess = () => {
  return (
    ...
    https://epicglobal.co.in/  */}
        ...
        <meta
          name="title"
          content="Business Process Services| BPO Solutions Company |Epic Global
"
        ></meta>
        <meta
          name="description"
          content="Epic Global provides business process outsourcing (BPO) services at reasonable prices. Contact us today for cost-effective and high-quality BPO solutions. visit now
"
        ></meta>
      </Head>
