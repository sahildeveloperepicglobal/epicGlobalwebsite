...
const ProjectManagement = () => {
  return (
    ...
    https://epicglobal.co.in/  */}
        ...
        <meta
          name="title"
          content="Project Management|Project Management Services |Epic Global"
        ></meta>
        <meta
          name="description"
          content="Epic Global project management reduces risk, ensures quality, and ensures that your project is completed on time and within budget. Find out more."
        ></meta>
      </Head>
        ...
        <div className={`${css["project-management"]} container2 mcenter`}>
          <div className={`${css["first-block"]} `}>
            ...
            <p>
              ...
              India and the United Kingdom, Epic Global is a full-service firm
              ...
              comprehensive and effective project management services.
            </p>
          </div>
          <div className={css["second-block"]}>
            ...
            <p>
              ...
              and trust. Our project managers are adept at facilitating
          ...
          <div className={css["paragraph-partition"]}>
            <div className={css["left-partition"]}>
              ...
              <p>
                ...
                issues and pivot when needed. We also use the latest
                technologies and tools to ensure our clients have access to the
                most up-to-date information and progress.
              </p>
            </div>
            <div className={css["right-partition"]}>
              ...
              <p>
                ...
                the industry. With our comprehensive approach, we provide the
          ...
          <div className={css["bottom-paragraph"]}>
            ...
            <p>
              ...
              project managers is highly experienced in the full range of
              project management disciplines, from requirements gathering to
              project planning and execution. We employ a comprehensive suite of
              project management methodologies and tools to ensure our clients
              get maximum value from their projects.
            </p>
          </div>
